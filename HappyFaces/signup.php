...
if(isset($_POST['submit'])){
    ...
    $query_acc = mysqli_query ($con, "SELECT * FROM staff_email WHERE email = '$email'");
    $numAcc = mysqli_num_rows ($query_acc);

    //Validation
    if(strlen($fName) < 3) {
        $error = "First Name should have more than 3 characters.";
    }
    else if(strlen($lName) < 3) {
        $error = "Last Name should have more than 3 characters.";
    }
    ...
    else if($acc_type == 'Staff' && $numAcc <= 0) {
        $error = "Staff Permission not granted!";
    }
    else if(strlen($password) < 4) {
        $error = "Passwrod must be greater than four characters";
    }
        ...
        $insertQuery = "INSERT INTO users (acc_type, fName, lName, mobile, email, pwd) VALUES ('$acc_type', '$fName', '$lName','$mobile' , '$email', '$password')";
        ...
        <div class="row">
          ...
          <div id="formdiv">
            <form method="POST" action="signup.php" enctype="multipart/form-data">
                ...
                <input type="text" name="mobil" class="inputFields" required /><br/><br/>

                <label>Select Account Type:</label><br>
                <input type="radio" id="member" name="acc_type" value="Member" checked>
                <label>Member</label>&nbsp;&nbsp;&nbsp;
                <input type="radio" id="staff" name="acc_type" value="Staff">
                <label>Staff</label><br><br><br>

                <input type="submit" name="submit" class="fil"/><br/>
            </form><br>
        </div>
        </div>
      </div><br><br><br><br><br>
