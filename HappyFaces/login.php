...
if (isset($_POST['submit'])){
    ...
    if (email_exists($email, $con)) {
        //verify pwd if email exists
        $result = mysqli_query($con, "SELECT pwd FROM users WHERE email = '$email'");
        $retrievepassword = mysqli_fetch_assoc($result);
        if (password_verify($password, $retrievepassword['pwd'])) {
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Login</h2><br>
              <span>No account? &nbsp;<a class="filled-button" style="color:black;" href="signup.php">Sign Up</a></span>
            </div>
          </div>
          <div class="down-content" id="formdiv">
                <form method="POST" action="login.php" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="submit" class="fil" style="color:black;" value="Login"/><br/>
                </form><br>
          </div>
        </div>
      </div>
