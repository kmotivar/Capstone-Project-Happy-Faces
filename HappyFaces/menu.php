...
<html lang="en">
  ...
  <div id="error" class = "error1" style=" <?php  if($error !=""){ ?>  display:block; <?php } ?> "><?php echo $error; ?></div>
    ...
    <div class="services">
      <div class="container">
        <div class="row">
          <div class="col-md-6"><a href="mlunch.php">
            <div class="service-item">
              <img src="assets/images/lun.png" alt="">
              <div class="down-content1">
                <h1 style="color: black;" class='headd'>Lunch</h1>
              </div>
            </div></a>
          </div>

          <div class="col-md-6"><a href="mdinner.php">
            <div class="service-item">
              <img src="assets/images/product-1-720x480.jpg" alt="">
              <div class="down-content1">
                <h1 style="color: black;" class='headd'>Dinner</h1>
              </div>
            </div>
          </div></a>
        </div>
