...
<html lang="en">
  ...
  <header class="">
          ...
          <div class="col-md-12">
            <div class="more-info-content">
              <div class="row">
                ...
                <br><p>We want to bring a change by training the homeless and help them take a step forward for sustainibility.</p>   
              </div>
                </div>
                <div class="col-md-6">
    ...
    <div class="fun-facts" style="background-image:url(assets/images/back.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="left-content">
              <span>happy Faces</span>
              <h2>Real-Time <em>Statistics</em></h2>
              <p style="font-size: 20px;">The displayed data is the current status of Happy Faces. 
              <br><br>We aim towards increasing these numbers significantly.</p>
            </div>
          </div>
          <div class="col-md-6 align-self-center">
            <div class="row">
              <div class="col-md-6">
                <div class="count-area-content">
                  ...
                  <div class="count-title">Meals served</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">0</div>
                  <div class="count-title">Homeless Hired</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">1</div>
                  <div class="count-title">City</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">1</div>
                  <div class="count-title">Location</div>
                </div>
              </div>
            </div>
          </div>
